...
This repository contains a completed assessment of the "Project Local Library". The project helps you learn how to create local Library page using JavaScript, while also getting familiar with basic design principles.
