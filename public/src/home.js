function getTotalBooksCount(books) {
  // Simply return the number of books in the array
  return books.length;
}

function getTotalAccountsCount(accounts) {
  // Simply return the number of accounts in the array
  return accounts.length;
}

function getBooksBorrowedCount(books) {
  // Count how many books are currently checked out (not yet returned)
